...
import { PROPERTY_TYPE_LABELS, type Property, type Tenancy, type ComplianceRecord } from '@/lib/types';
      ...
      {allProperties.length === 0 ? (
        ...
        <div className="space-y-3">
          {allProperties.map((property) => {
            ...
            const score = calculatePropertyScore(propertyCompliance);
            ...
            return (
              <Link key={property.id} href={`/app/properties/${property.id}`}>
                <Card interactive glow padding="md" className="flex items-center gap-4">
                  {/* Score */}
