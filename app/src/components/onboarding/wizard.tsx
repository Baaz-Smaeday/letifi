...
import {
  RESIDENTIAL_TYPES, COMMERCIAL_TYPES, PROPERTY_TYPE_ICONS,
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <Select
                  ...
                  options={[]}
                  groups={[
                    { label: '🏠 Residential', options: RESIDENTIAL_TYPES.map(t => ({ value: t, label: `${PROPERTY_TYPE_ICONS[t]} ${PROPERTY_TYPE_LABELS[t]}` })) },
                    { label: '🏪 Commercial', options: COMMERCIAL_TYPES.map(t => ({ value: t, label: `${PROPERTY_TYPE_ICONS[t]} ${PROPERTY_TYPE_LABELS[t]}` })) },
                  ]}
                />
                <Select
                  label="Ownership"
