...
export function IconDashboard({ className }: IconProps) {
  return (
    <svg className={cn('w-5 h-5', className)} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export function IconChevronRight({ className }: IconProps) {
  return (
    <svg className={cn('w-4 h-4', className)} fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
