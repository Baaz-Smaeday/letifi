...
// ============================================
// Auto-expiry suggestions (months)
// ============================================
export const COMPLIANCE_EXPIRY_MONTHS: Partial<Record<ComplianceType, number>> = {
  gas_safety: 12,
  eicr: 60,       // 5 years
  epc: 120,       // 10 years
  smoke_co_alarm: 12,
  deposit_protection: 0,  // matches tenancy
  right_to_rent: 12,
  legionella: 24,
  property_licence: 60,
  fire_safety: 12,
  landlord_insurance: 12,
  rent_agreement: 12,
  food_hygiene: 24,
  premises_licence: 12,
  asbestos_survey: 120,
...
export const COMPLIANCE_HELP_TEXT: Partial<Record<ComplianceType, string>> = {
  gas_safety: 'Annual gas safety check by a Gas Safe registered engineer. Legally required for all rented properties with gas appliances.',
  eicr: 'Electrical Installation Condition Report. Required every 5 years for rented properties in England.',
  epc: 'Energy Performance Certificate. Must be rated E or above. Valid for 10 years.',
  smoke_co_alarm: 'Working smoke alarms on every floor and CO alarms where solid fuel is used. Check annually.',
  deposit_protection: 'Tenant deposit must be protected in a government-approved scheme within 30 days.',
  right_to_rent: 'Verify tenant has legal right to rent in England. Check before tenancy starts.',
  legionella: 'Risk assessment for Legionella bacteria in water systems. Recommended every 2 years.',
  property_licence: 'HMO or selective licensing from local council. Check your area requirements.',
  fire_safety: 'Fire safety measures including fire doors, extinguishers, and escape routes.',
  landlord_insurance: 'Buildings and landlord liability insurance. Renew annually.',
  rent_agreement: 'Written tenancy agreement. Update when terms change or tenancy renews.',
  food_hygiene: 'Food Hygiene Rating from local authority. Required for food businesses.',
  premises_licence: 'Licence to sell alcohol or provide entertainment. From local council.',
  asbestos_survey: 'Asbestos management survey for commercial properties built before 2000.',
  fire_risk_assessment: 'Formal fire risk assessment required for commercial premises.',
  commercial_epc: 'Display Energy Certificate for commercial properties over 250 sq metres.',
};
